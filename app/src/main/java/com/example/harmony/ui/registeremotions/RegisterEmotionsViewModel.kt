...
class RegisterEmotionsViewModel(private val registerEmotionsModel: RegisterEmotionsModel, private val context: Context) : ViewModel(), DrawerActions, DataBaseActions {
